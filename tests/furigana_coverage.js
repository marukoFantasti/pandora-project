...
const VECTORS = [
  ...
  // backfill g04/対称解説の増補で検出した誤読の封印: 重なる=かさ・回す=まわ・区切る=くぎ・「間の角」=あいだ(「日間の」を巻き込まない)
  ['ぴったり重なります', 'ぴったりかさなります'], ['180度回したとき', 'ひゃくはちじゅうどまわしたとき'], ['4けたずつ区切ると', 'よんけたずつくぎると'], ['2つの間の角', 'ふたつのあいだのかく'], ['4日間の観客数', 'よっかかんのかんきゃくすう'], ['一つ', 'ひとつ'], ['間の角は', 'あいだのかくは'],
  // 対称第2便: 本数=ほんすう・最も=もっと・等脚台形
  ['軸の本数が最も少ない', 'じくのほんすうがもっともすくない'], ['等脚台形', 'とうきゃくだいけい'], ['表の空らんをうめなさい', 'ひょうのくうらんをうめなさい'],
  // backfill g03: 九九=くく・必要・場面・気をつけ・一番
  ['7の段の九九', 'ななのだんのくく'], ['あと1つ必要です', 'あとひとつひつようです'], ['くり上がりに気をつけて', 'くりあがりにきをつけて'], ['一番大きい答え', 'いちばんおおきいこたえ'], ['ことが大切です', 'ことがたいせつです'], ['分は分どうしをたして', 'ふんはふんどうしをたして'], ['整数部分は', 'せいすうぶぶんは'],
  // 概形第1便: 約N(単位)=やく・千葉県
  ['答え 約1200m²', 'こたえ やくせんにひゃくへいほうメートル'], ['千葉県の地図を参考に', 'ちばけんのちずをさんこうに'],
  // backfill g05: 分かる=わ(「分=ぶん」の誤爆)・最大公約数・底角
  ['答えが分かります', 'こたえがわかります'], ['最大公約数は', 'さいだいこうやくすうは'], ['2つの底角', 'ふたつのていかく'],
  ['縮図上の長さ', 'しゅくずじょうのながさ'], ['速さを比べると比が', 'はやさをくらべるとひが'], ['1人分は姉の分は', 'ひとりぶんはあねのぶんは'], ['組み合わせを数えて柱の高さ', 'くみあわせをかぞえてはしらのたかさ'], ['数直線の0と1の間が5等分', 'すうちょくせんのれいといちのあいだがごとうぶん'], ['約分して1/4分です', 'やくぶんしてよんぶんのいっぷんです'], ['1と1/2分', 'いちとにぶんのいっぷん'], ['3/4mのテープ', 'よんぶんのさんメートルのテープ'], ['3分の1は', 'さんぶんのいちは'], ['4分の1と書きます', 'よんぶんのいちとかきます'], ['何分の一', 'なんぶんのいち'], ['3分の2m', 'さんぶんのにメートル'], ['午前10時35分の30分後は', 'ごぜんじゅうじさんじゅうごふんのさんじゅっぷんごは'], ['2分の一といい', 'にぶんのいちといい'], ['1くり下げて', 'いちくりさげて'], ['時こくの分に10をたします', 'じこくのふんにじゅうをたします'], ['のこりが分になります', 'のこりがふんになります'], ['変わり方のようすを', 'かわりかたのようすを'], ['時こく・月・年のように', 'じこく・つき・ねんのように'], ['答えは−11/45です', 'こたえはマイナスよんじゅうごぶんのじゅういちです'], ['b＝…の形に変形する', 'b＝…のかたちにへんけいする'], ['x人とすると、x年後', 'xにんとすると、xねんご'], ['yが消えて、解いて', 'yがきえて、といて'], ['y＝12/x上の点', 'y＝じゅうに/xじょうのてん'], ['aが分かれば、x分後に', 'aがわかれば、xふんごに'], ['一直線上に並んで', 'いっちょくせんじょうにならんで'], ['n角形の内角の和・同位角・錯角', 'nかくけいのないかくのわ・どういかく・さっかく'], ['階級値と出方を（大，小）で', 'かいきゅうちとでかたを（だい，しょう）で'], ['小数第1位を四捨五入', 'しょうすうだいいちいをししゃごにゅう'], ['3時間をこえた分は', 'さんじかんをこえたぶんは'], ['空間で2直線が・重解', 'くうかんでにちょくせんが・じゅうかい'], ['根号の外に出すと3√11', 'こんごうのそとにだすとさん√じゅういち'], ['底面積×2＋側面積', 'ていめんせき×に＋そくめんせき'], ['解の公式で解いて、解は2つ', 'かいのこうしきでといて、かいはふたつ'],
];
...
(function () {
  ...
  Object.keys(lex).forEach(k => {
    ...
    if ((k.match(/[一-鿿々]+/g) || []).length > 1) return;   // 漢字連が2つ以上の表層(切り捨て等)は全表層読み(グループルビ)=規約の対象外
